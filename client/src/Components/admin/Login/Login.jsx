            ...
            <div class="container-fluid h-custom">
                <div class="row d-flex justify-content-center align-items-center h-100">
                    ...
                    <div class="col-md-9 col-lg-6 col-xl-5">
                        <img src="https://media.istockphoto.com/id/1211888212/video/welcome-sign-linear-gradient-left-right-transition-on-black-background.jpg?s=640x640&k=20&c=xBR39Eb-x-7PbmogeUKXC547ludgju90au64VEZ9J9k=" class="img-fluid" alt="Sample image" />
                    </div>
